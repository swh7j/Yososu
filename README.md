...
|날짜|내용|
|----|----|
|2021.12.05|주제 선정 <br>화면 구성 1차 논의 및 화면 구조도 작성<br>Front 초안 제작(Scenebuilder)</br>|
|2021.12.08|Logo 제작 및 논의<br>화면 구성 2차 논의<br>controller 구조도 제작</br>|
|2021.12.09|Database 설계|
|2021.12.10|Scenebuilder 화면전환 구현|
|2021.12.11|문서화(화면구조, controller 구조, DB구조)<br>Scenebuilder fx:id 명명<br>최종 역할분담 <br>Database schema 및 table 생성</br>|
|2021.12.12 ~ 2021.11.17|개인 작업|
|2021.12.18 ~ 2021.11.21|프로젝트 연결 및 오류 수정|
|2021.12.22|프로젝트 발표|
